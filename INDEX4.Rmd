...
Una vez realizadas las pruebas con el crieterio de información akaike, se confirma el resultado obtenido con la r cuadrada ajustada en relación a la aplicación del primer modelo de regresión que es el que mejor explica el resultado de las ventas, ya que el criterio nos da el menor porcentaje con el primer modelo de 455.73 versus el segundo modelo en que se elimina la variable de precio y que da como resultado un 461.10. Y finalmente el modelo de regresión en que se elimina a la publicidad nos da un valor de 494.54 . 